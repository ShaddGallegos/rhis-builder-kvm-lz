# MRHIS Script Run Checklist

Use this checklist before running `MRHIS.sh`.
...
Other runtime directories/files (for example `inventory/`, `host_vars/`, generated docs/runtime placeholders) are expected to be created by `MRHIS.sh` when missing.
